    ...
    module InstanceMethods
      ...
      def acl_ajax_counter(action_name, options={})
        ...
        if settings['enable_ajax_counters']
          ...
          acl_counters = settings['acl_counters'] || {}
          old_counter = acl_counters[action_md5]
          ...
          if old_counter.blank? || old_counter != new_counter
            acl_counters[action_md5] = new_counter
            settings['acl_counters'] = acl_counters
            Setting.plugin_a_common_libs = settings
          end
